...
<head>
<meta charset="utf-8">
<title>Recipes To Go &rarr; Logout</title>
...
></span> items)</a></div>
  ...
  <div id="content">
    ...
    <section class="mainContent">
		<div class="main">
<h1>You have now been logged out of your account. Thank you!</h1>
<?php
session_start();
$_SESSION = array();
session_destroy();
?>
			...
			<p>Logged out in error? <a href="login-test.php"><b>Login</b></a> again!</p>
